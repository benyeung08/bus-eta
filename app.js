...
const EP = {
  ...
  lrtEta      :(id)=>`https://rt.data.gov.hk/v1/transport/mtr/lrt/getSchedule?station_id=${encodeURIComponent(id)}&with_special=1`,
  lrtCsv      :'https://opendata.mtr.com.hk/data/light_rail_routes_and_stops.csv',
...
const CO_NAME = {KMB:'九巴/龍運', CTB:'城巴', NLB:'嶼巴', GMB:'專線小巴', MTRB:'港鐵巴士', MTR:'港鐵重鐵', LRT:'輕鐵'};
const CO_CLS  = {KMB:'kmb', CTB:'ctb', NLB:'nlb', GMB:'gmb', MTRB:'mtrb', MTR:'mtr', LRT:'lrt'};

/* ---------------- 港鐵內建資料（車站、所屬線、座標） ---------------- */
/* [代碼, 中文, 英文, 緯度, 經度] */
const MTR_LINES = [
  {code:'ISL', name:'港島綫', color:'#0075C1', st:[
    ['KET','堅尼地城',22.2813,114.1289],['HKU','香港大學',22.2841,114.1353],['SYP','西營盤',22.2860,114.1425],
    ['SHW','上環',22.2870,114.1512],['CEN','中環',22.2820,114.1581],['ADM','金鐘',22.2790,114.1651],
    ['WAC','灣仔',22.2770,114.1726],['CAB','銅鑼灣',22.2805,114.1850],['TIH','天后',22.2830,114.1920],
    ['FOH','炮台山',22.2877,114.1945],['NOP','北角',22.2915,114.2008],['QUB','鰂魚涌',22.2885,114.2100],
    ['TAK','太古',22.2853,114.2163],['SWH','西灣河',22.2820,114.2215],['SKW','筲箕灣',22.2780,114.2280],
    ['HFC','杏花邨',22.2755,114.2395],['CHW','柴灣',22.2648,114.2366]]},
  {code:'TWL', name:'荃灣綫', color:'#E1002A', st:[
    ['CEN','中環',22.2820,114.1581],['ADM','金鐘',22.2790,114.1651],['TST','尖沙咀',22.2975,114.1722],
    ['JOR','佐敦',22.3044,114.1714],['YMT','油麻地',22.3124,114.1703],['MOK','旺角',22.3193,114.1692],
    ['PRE','太子',22.3246,114.1678],['SSP','深水埗',22.3308,114.1629],['CSW','長沙灣',22.3355,114.1585],
    ['LCK','荔枝角',22.3400,114.1522],['MEF','美孚',22.3395,114.1435],['LAK','荔景',22.3412,114.1300],
    ['KWF','葵芳',22.3568,114.1285],['KWH','葵興',22.3616,114.1337],['TWH','大窩口',22.3702,114.1350],
    ['TSW','荃灣',22.3736,114.1240]]},
  {code:'KTL', name:'觀塘綫', color:'#00A650', st:[
    ['WHA','黃埔',22.3055,114.1890],['HOM','何文田',22.3095,114.1815],['YMT','油麻地',22.3124,114.1703],
    ['MOK','旺角',22.3193,114.1692],['PRE','太子',22.3246,114.1678],['SKM','石硤尾',22.3315,114.1710],
    ['KOT','九龍塘',22.3375,114.1755],['LOF','樂富',22.3382,114.1850],['WTS','黃大仙',22.3420,114.1930],
    ['DIH','鑽石山',22.3400,114.2020],['CHH','彩虹',22.3355,114.2095],['KOB','九龍灣',22.3235,114.2140],
    ['NTK','牛頭角',22.3150,114.2160],['KWT','觀塘',22.3100,114.2255],['LAT','藍田',22.3065,114.2345],
    ['YAT','油塘',22.2970,114.2370],['TIK','調景嶺',22.3040,114.2530]]},
  {code:'TKL', name:'將軍澳綫', color:'#7A3285', st:[
    ['NOP','北角',22.2915,114.2008],['QUB','鰂魚涌',22.2885,114.2100],['YAT','油塘',22.2970,114.2370],
    ['TIK','調景嶺',22.3040,114.2530],['TKO','將軍澳',22.3075,114.2600],['HAH','坑口',22.3150,114.2660],
    ['POA','寶琳',22.3230,114.2575],['LHP','康城',22.2950,114.2710]], br:['LHP'], x:[['TKO','LHP']]},
  {code:'TCL', name:'東涌綫', color:'#F79433', st:[
    ['HOK','香港',22.2855,114.1580],['KOW','九龍',22.3055,114.1630],['OLY','奧運',22.3185,114.1600],
    ['NAC','南昌',22.3260,114.1530],['LAK','荔景',22.3412,114.1300],['TSY','青衣',22.3575,114.1075],
    ['SUN','欣澳',22.3330,114.0720],['TUC','東涌',22.2890,113.9435]]},
  {code:'AEL', name:'機場快綫', color:'#00888F', st:[
    ['HOK','香港',22.2855,114.1580],['KOW','九龍',22.3055,114.1630],['TSY','青衣',22.3575,114.1075],
    ['AIR','機場',22.3140,113.9370],['AWE','博覽館',22.3230,113.9450]]},
  {code:'DRL', name:'迪士尼綫', color:'#F576A6', st:[
    ['SUN','欣澳',22.3330,114.0720],['DIS','迪士尼',22.3130,114.0410]]},
  {code:'EAL', name:'東鐵綫', color:'#5CB7E8', st:[
    ['ADM','金鐘',22.2790,114.1651],['EXC','會展',22.2815,114.1740],['HUH','紅磡',22.3030,114.1810],
    ['MKK','旺角東',22.3225,114.1730],['KOT','九龍塘',22.3375,114.1755],['TAW','大圍',22.3730,114.1805],
    ['SHT','沙田',22.3825,114.1875],['FOT','火炭',22.3960,114.1975],['RAC','馬場',22.3995,114.2050],
    ['UNI','大學',22.4130,114.2095],['TAP','大埔墟',22.4445,114.1990],['TWO','太和',22.4520,114.1900],
    ['FAN','粉嶺',22.4925,114.1890],['SHS','上水',22.5055,114.1890],['LOW','羅湖',22.5280,114.1130],
    ['LMC','落馬洲',22.5140,114.0650]], br:['LMC'], x:[['SHS','LMC']]},
  {code:'TML', name:'屯馬綫', color:'#923011', st:[
    ['WKS','烏溪沙',22.4290,114.2455],['MOS','馬鞍山',22.4245,114.2320],['HEO','恆安',22.4210,114.2240],
    ['TSH','大水坑',22.4140,114.2190],['SHM','石門',22.4045,114.2090],['CIO','第一城',22.3865,114.2070],
    ['STW','沙田圍',22.3810,114.1975],['CKT','車公廟',22.3745,114.1900],['TAW','大圍',22.3730,114.1805],
    ['HIK','顯徑',22.3645,114.1720],['DIH','鑽石山',22.3400,114.2020],['KAT','啟德',22.3300,114.2010],
    ['SUW','宋皇臺',22.3250,114.1930],['TKW','土瓜灣',22.3175,114.1880],['HOM','何文田',22.3095,114.1815],
    ['HUH','紅磡',22.3030,114.1810],['ETS','尖東',22.2945,114.1750],['AUS','柯士甸',22.3045,114.1670],
    ['NAC','南昌',22.3260,114.1530],['MEF','美孚',22.3395,114.1435],['TWW','荃灣西',22.3685,114.1115],
    ['KSR','錦上路',22.4320,114.0630],['YUL','元朗',22.4455,114.0360],['LOP','朗屏',22.4480,114.0260],
    ['TIS','天水圍',22.4590,114.0040],['SIH','兆康',22.4135,113.9780],['TUM','屯門',22.3935,113.9730]]},
  {code:'SIL', name:'南港島綫', color:'#BAC533', st:[
    ['ADM','金鐘',22.2790,114.1651],['OCP','海洋公園',22.2515,114.1690],['WCH','黃竹坑',22.2475,114.1700],
    ['LET','利東',22.2405,114.1590],['SOH','海怡半島',22.2400,114.1480]]},
];
...
/* ---------- 輕鐵 ----------
   官方 light_rail_routes_and_stops.csv 提供編號／名稱／路線，但<b>沒有經緯度</b>，
   下列座標為人工整理之近似值（誤差約 100–300 公尺），僅供「附近」排序參考。
   若需精確座標，請以 OSM／政府地理資料覆寫 LRT_COORDS。 */
const LRT_COORDS = {
  '屯門碼頭':[22.3733,113.9626], '美樂':[22.3728,113.9652], '蝴蝶':[22.3722,113.9676],
  '輕鐵車廠':[22.3724,113.9702], '龍門':[22.3740,113.9726], '青山村':[22.3761,113.9748],
  '青雲':[22.3783,113.9770], '建安':[22.3804,113.9792], '山景（南）':[22.3812,113.9813],
  '山景（北）':[22.3826,113.9822], '石排':[22.3840,113.9836], '新圍':[22.3853,113.9848],
  '良景':[22.3866,113.9859], '田景':[22.3878,113.9870], '建生':[22.3892,113.9881],
  '青松':[22.3907,113.9891], '麒麟':[22.3922,113.9895], '兆康':[22.4080,113.9808],
  '藍地':[22.4160,113.9845], '泥圍':[22.4214,113.9862], '鍾屋村':[22.4262,113.9880],
  '洪水橋':[22.4305,113.9900], '塘坊村':[22.4340,113.9920], '坑尾村':[22.4310,113.9950],
  '屏山':[22.4375,113.9945], '水邊圍':[22.4405,114.0020], '豐年路':[22.4420,114.0110],
  '康樂路':[22.4430,114.0190], '大棠道':[22.4440,114.0240], '元朗':[22.4455,114.0320],
  '市中心':[22.3915,113.9770], '安定':[22.3895,113.9755], '友愛':[22.3885,113.9735],
  '兆麟':[22.3900,113.9715], '三聖':[22.3890,113.9685], '豐景園':[22.3905,113.9730],
  '海皇路':[22.3915,113.9700], '屯門泳池':[22.3915,113.9700], '屯門':[22.3940,113.9775],
  '何福堂':[22.3965,113.9795], '杯渡':[22.3985,113.9805], '新墟':[22.4005,113.9815],
  '景峰':[22.4025,113.9825], '鳳地':[22.4045,113.9825], '河田':[22.3935,113.9740],
  '蔡意橋':[22.3925,113.9760], '澤豐':[22.3920,113.9840], '銀圍':[22.3900,113.9855],
  '大興（南）':[22.3885,113.9865], '大興（北）':[22.3870,113.9875], '屯門醫院':[22.3935,113.9885],
  '天水圍':[22.4497,114.0030], '天耀':[22.4500,114.0000], '樂湖':[22.4510,113.9980],
  '天瑞':[22.4525,113.9990], '翠湖':[22.4535,114.0010], '天榮':[22.4520,114.0060],
  '銀座':[22.4535,114.0075], '天湖':[22.4545,114.0050], '天慈':[22.4500,114.0045],
  '頌富':[22.4570,114.0030], '天富':[22.4585,114.0010], '天逸':[22.4600,114.0030],
  '天恆':[22.4590,114.0060], '濕地公園':[22.4610,114.0080], '天秀':[22.4620,114.0100],
  '天悅':[22.4625,114.0055], '天城':[22.4560,114.0080],
};
...
async function loadLrt(){
  ...
  const byName = new Map();      // 中文名 -> 站
  const rsAt = new Map();        // 站號 -> 路線
  const routeSet = new Set();
  let txt = null;
  try{ txt = await cachedText(EP.lrtCsv, 24*3600e3, {timeout:30000}); }catch(e){}
  if(txt){
    const rows = parseCSV(txt);
    if(rows.length>1){
      const h = rows[0];
      const cLine = csvCol(h,'Line Code','LineCode','line_code','路線');
      const cId   = csvCol(h,'Stop ID','StopID','stop_id','Station ID','站編號','車站編號');
      const cName = csvCol(h,'Chinese Name','Stop Name TC','Stop Name','name_tc','車站名稱','站名');
      const cEn   = csvCol(h,'English Name','Stop Name EN','name_en');
      const cSeq  = csvCol(h,'Sequence','Stop Seq','stop_seq','seq','站序');
      for(let i=1;i<rows.length;i++){
        const r = rows[i];
        const id   = String((cId>=0?r[cId]:'')||'').trim();
        const name = ((cName>=0?r[cName]:'')||'').trim();
        const line = String((cLine>=0?r[cLine]:'')||'').trim();
        if(!id || !name) continue;
        if(!byName.has(name)){
          const co = LRT_COORDS[name];
          byName.set(name, {co:'LRT', id, tc:name, en:(cEn>=0?(r[cEn]||'').trim():''),
                            lat: co?co[0]:NaN, lng: co?co[1]:NaN,
                            approx: true});      // 座標為近似值，距離僅供參考
        }
        if(line){
          routeSet.add(line);
          const st = byName.get(name);
          if(!rsAt.has(st.id)) rsAt.set(st.id, []);
          if(!rsAt.get(st.id).some(x=>x.route===line)) rsAt.get(st.id).push({route:line, bound:''});
        }
      }
    }
  }
  // 沒有座標的站不能用於「附近」，但保留在索引中供站名搜尋
  const stops = [...byName.values()];
  D.LRT.stop       = stops.filter(x=>isFinite(x.lat) && isFinite(x.lng));
  ...
  D.LRT.ready      = D.LRT.stop.length>0;
  if(D.LRT.stop.length) _allStopsCache = null;
}
...
function nearCounts(){
  const c = {ALL:0, KMB:0, CTB:0, GMB:0, NLB:0, MTRB:0, MTR:0, LRT:0};
  (nearData.allInRange || nearData.stops).forEach(x=>{
    c.ALL++; if(c[x.s.co]!==undefined) c[x.s.co]++;
  });
  return c;
}
const CO_SHORT = {ALL:'全部', KMB:'九巴', CTB:'城巴', GMB:'小巴', NLB:'嶼巴', MTRB:'港鐵巴', MTR:'港鐵', LRT:'輕鐵'};
function renderNearBox(){
  ...
  let h = `<div class="card">
    ...
    <div class="chipbar" id="nearCo" style="margin-top:6px">
      ${['ALL','KMB','CTB','GMB','NLB','MTRB','MTR','LRT'].filter(k=>k==='ALL'||cc[k]>0||((k==='MTRB'&&!D.MTRB.ready)||(k==='LRT'&&!D.LRT.ready))).map(k=>
...
function renderDataStatus(){
  ...
  [['九巴/龍運',D.KMB.ready],['城巴',D.CTB.ready],['專線小巴',D.GMB.ready],['嶼巴',D.NLB.ready],
   ['港鐵巴士',D.MTRB.ready],['港鐵重鐵',D.MTR.ready],['輕鐵',D.LRT.ready]]
  ...
  el.innerHTML = `車站／路線索引：${ok.map(n=>`<span class="ok">✓${n}</span>`).join(' ')}` +
    ...
    (D.LRT.ready ? `<div class="tiny muted" style="margin-top:3px">輕鐵站座標為近似值（官方 CSV 未提供座標），距離僅供參考。</div>` : '');
  if(!ok.length){
